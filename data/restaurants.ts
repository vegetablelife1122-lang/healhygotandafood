...
export const restaurants: Restaurant[] = [
  ...
  // ===== 西五反田 イタリアン追加 =====
  {
    ...
    estimatedCalories: 700,
    drinkPairings: ["ワイン", "ビール", "カクテル", "ソフトドリンク"],
    description: "西五反田2丁目・大衆酒場×イタリアン融合店。18:30までハッピーアワーでドリンク280円〜、レバカツ55円〜とコスパ抜群。",
    reasonTags: ["コスパ抜群", "大衆イタリアン", "ハッピーアワー"],
    walkingMinutes: 2,
    healthScore: 2,
    healthTags: ["揚げ物あり"],
  ...
  },
  {
    ...
    estimatedCalories: 900,
    drinkPairings: ["ワイン", "ビール", "カクテル", "ソフトドリンク"],
    description: "駅徒歩1分・FPGlinksGOTANDA 5F。完全個室でタパスと厳選肉料理が楽しめるビストロ。女子会・記念日・パーティーにも対応。",
    reasonTags: ["完全個室", "記念日向き", "駅徒歩1分"],
    walkingMinutes: 1,
    healthScore: 3,
    healthTags: ["野菜多め", "肉料理充実"],
  ...
  },
  {
    ...
    estimatedCalories: 650,
    drinkPairings: ["ワイン", "ビール", "カクテル", "ソフトドリンク"],
    description: "西五反田1丁目の大衆イタリアン居酒屋。スパークリングワイン含む全14種ドリンクが280円のハッピーアワーあり。",
    reasonTags: ["コスパ抜群", "ハッピーアワー", "大衆イタリアン"],
    walkingMinutes: 5,
    healthScore: 2,
    healthTags: ["揚げ物あり"],
    address: "品川区西五反田1-15-10",
  ...
  },
  {
    ...
    budget: "¥6,000〜7,999",
    estimatedCalories: 900,
    drinkPairings: ["ワイン", "ソフトドリンク"],
    description: "菅原ビル4F・22席のアットホームなビストロ。イタリアン×フレンチ融合料理で、テラス席から東急池上線が眺められる隠れ家。",
    reasonTags: ["隠れ家ビストロ", "フレンチ×イタリアン", "テラス席"],
    walkingMinutes: 3,
    healthScore: 4,
    healthTags: ["野菜多め", "揚げ物少なめ"],
  ...
  },
  {
    ...
    estimatedCalories: 950,
    drinkPairings: ["ワイン", "ビール", "ソフトドリンク"],
    description: "駅徒歩1分・石窯で焼き上げる大山鶏のロースト鶏が名物。ソムリエ選定ワインと個室・テラス席あり。",
    reasonTags: ["石窯ローストチキン", "ソムリエワイン", "駅徒歩1分"],
    walkingMinutes: 1,
    healthScore: 4,
    healthTags: ["野菜多め", "揚げ物少なめ"],
  ...
  },
  {
    ...
    estimatedCalories: 850,
    drinkPairings: ["ワイン", "ビール", "ソフトドリンク"],
    description: "薪窯で焼く本格ナポリピッツァ専門店。24時間以上熟成させた生地は軽い食感が自慢。イタリア産食材使用。",
    reasonTags: ["薪窯ナポリピッツァ", "熟成生地", "イタリア産食材"],
    walkingMinutes: 4,
    healthScore: 3,
    healthTags: ["野菜多め"],
  ...
  },
  {
    ...
    estimatedCalories: 600,
    drinkPairings: ["ワイン", "ソフトドリンク"],
    description: "目黒川沿いの閑静なエリア。ナチュラルワイン常時15種以上と旬の素材をシンプルに調理した小皿料理の店。",
    reasonTags: ["ナチュラルワイン", "小皿料理", "目黒川沿い"],
    walkingMinutes: 5,
    healthScore: 4,
    healthTags: ["野菜多め", "軽め"],
  ...
  },
  {
    ...
    estimatedCalories: 1000,
    drinkPairings: ["ワイン", "ソフトドリンク"],
    description: "フランス三ツ星出身シェフによる地下の隠れ家ビストロ。京野菜・和牛・鮮魚を使ったフレンチ×イタリアンのコース料理。",
    reasonTags: ["三ツ星出身シェフ", "京野菜×和牛", "隠れ家地下"],
    walkingMinutes: 2,
    healthScore: 5,
  ...
  },
  {
    ...
    estimatedCalories: 700,
    drinkPairings: ["ソフトドリンク", "飲まない"],
    description: "ミシュランシェフ・鳥羽周作氏監修の生パスタ専門店。五反田JPビル内フードコートで手軽に本格生パスタが味わえる。",
    reasonTags: ["ミシュラン監修", "生パスタ専門", "コスパ"],
    walkingMinutes: 6,
    healthScore: 3,
    healthTags: ["野菜多め"],
    address: "品川区西五反田8-4-13 五反田JPビルディング1F",
  ...
  },
  {
    ...
    estimatedCalories: 900,
    drinkPairings: ["ワイン", "ビール", "ソフトドリンク"],
    description: "人気店「リカーリカ」系列出身シェフの隠れ家イタリアン。オープンキッチンで料理を眺めながらワインを楽しめる。",
    reasonTags: ["隠れ家イタリアン", "ワイン充実", "オープンキッチン"],
    walkingMinutes: 9,
    healthScore: 4,
    healthTags: ["野菜多め", "揚げ物少なめ"],
  ...
  // ===== 西五反田 和食・居酒屋追加 =====
  {
    ...
    estimatedCalories: 750,
    drinkPairings: ["日本酒", "ビール", "ハイボール", "ソフトドリンク"],
    description: "昭和の雰囲気漂う海鮮居酒屋。厳選された天然魚の刺身盛りと旬の肴が自慢。一人客から宴会まで対応。",
    reasonTags: ["海鮮刺身", "昭和の雰囲気", "駅徒歩2分"],
    walkingMinutes: 2,
    healthScore: 4,
    healthTags: ["魚介系", "揚げ物少なめ"],
  ...
  {
    id: "w_iza02",
    name: "鉄板バル SOURCE 五反田店",
    area: "西五反田",
    visitTypes: ["ディナー", "軽く飲む"],
    genre: "居酒屋",
    budget: "¥3,000〜3,999",
    estimatedCalories: 800,
    drinkPairings: ["ビール", "ハイボール", "カクテル", "ソフトドリンク"],
    description: "大阪・天満発の鉄板焼き居酒屋。ふわふわ出汁生地のお好み焼き・どて焼き・イカ焼きなど関西名物が充実。プロジェクター付き個室あり。",
    reasonTags: ["鉄板焼き", "関西居酒屋", "個室あり"],
    walkingMinutes: 3,
    healthScore: 2,
    healthTags: ["揚げ物あり"],
  ...
  },
  {
    ...
    visitTypes: ["ディナー"],
    genre: "和食",
    budget: "¥13,000〜19,999",
    estimatedCalories: 1000,
    drinkPairings: ["日本酒", "ワイン", "ソフトドリンク"],
    description: "完全予約制・国産食材に特化した高級和食。全国厳選素材による創作コース料理と日本酒・ワインペアリングが楽しめる隠れ家。",
    reasonTags: ["高級和食", "完全予約制", "国産食材"],
    walkingMinutes: 3,
    healthScore: 5,
    healthTags: ["野菜多め", "こだわり食材"],
  ...
  },
  {
    ...
    estimatedCalories: 650,
    drinkPairings: ["ビール", "ハイボール", "レモンサワー", "ソフトドリンク"],
    description: "変わり種もんじゃ専門店。みそラーメン・四川風・イカスミなど個性的なメニューが揃い、もちもち太麺やきそばも人気。",
    reasonTags: ["変わり種もんじゃ", "ランチOK", "コスパ"],
    walkingMinutes: 5,
    healthScore: 3,
    healthTags: ["軽め"],
  ...
  },
  {
    ...
    estimatedCalories: 900,
    drinkPairings: ["ワイン", "ビール", "ソフトドリンク"],
    description: "ヤザワミート直営の隠れ家バル。黒毛和牛の鉄板焼き・無添加焼きそばが名物。カウンター中心の13席でシェフの仕事を間近に楽しめる。",
    reasonTags: ["ヤザワミート直営", "黒毛和牛鉄板", "隠れ家"],
    walkingMinutes: 3,
    healthScore: 3,
    healthTags: ["肉料理充実"],
  ...
  // ===== 東五反田 和食・居酒屋追加 =====
  {
    ...
    estimatedCalories: 700,
    drinkPairings: ["日本酒", "ビール", "ソフトドリンク"],
    description: "日本酒常時20種以上のおばんざい日本酒バル。個室7室完備で旬の食材を活かした料理と相性抜群の日本酒が楽しめる。",
    reasonTags: ["日本酒充実", "おばんざい", "個室7室"],
    walkingMinutes: 5,
    healthScore: 4,
    healthTags: ["野菜多め", "魚介系"],
  ...
  },
  {
    ...
    estimatedCalories: 700,
    drinkPairings: ["ビール", "ハイボール", "カクテル", "ソフトドリンク"],
    description: "肉・野菜・スイーツまで揃う串揚げ専門店。はちみつ料理やフルーツサワーが豊富でDAZN放映中。半個室あり。",
    reasonTags: ["串揚げ専門", "スポーツ観戦可", "駅徒歩3分"],
    walkingMinutes: 3,
    healthScore: 2,
    healthTags: ["揚げ物あり"],
  ...
  },
  {
    ...
    estimatedCalories: 700,
    drinkPairings: ["ビール", "カクテル", "ソフトドリンク"],
    description: "駅直結・五反田東急スクエア8F。ゴーヤチャンプル・沖縄そば・ラフテーなど本格沖縄料理と泡盛・オリオンビールが楽しめる。",
    reasonTags: ["沖縄料理", "駅直結", "泡盛"],
    walkingMinutes: 1,
    healthScore: 3,
    healthTags: ["野菜多め"],
    address: "品川区東五反田2-1-2 五反田東急スクエア8F",
  ...
  },
  {
    ...
    budget: "¥4,000〜5,999",
    estimatedCalories: 800,
    drinkPairings: ["ビール", "日本酒", "焼酎", "ソフトドリンク"],
    description: "国産牛もつ鍋と鮮魚刺身盛合せが名物の居酒屋。2階に8〜16名の完全個室あり。駅東口徒歩2分。",
    reasonTags: ["もつ鍋", "鮮魚刺身", "個室あり"],
    walkingMinutes: 2,
    healthScore: 3,
    healthTags: ["魚介系", "高たんぱく"],
  ...
  },
  {
    ...
    budget: "¥4,000〜4,999",
    estimatedCalories: 750,
    drinkPairings: ["ビール", "日本酒", "焼酎", "ハイボール", "ソフトドリンク"],
    description: "新鮮海鮮とリーズナブルな価格が自慢の居酒屋。もつ鍋・刺身盛りが人気で飲み放題コースも充実。",
    reasonTags: ["海鮮リーズナブル", "飲み放題コース", "駅徒歩1分"],
    walkingMinutes: 1,
    healthScore: 3,
    healthTags: ["魚介系"],
  ...
  },
  {
    ...
    budgetLunch: "¥1,000〜1,999",
    estimatedCalories: 750,
    drinkPairings: ["ビール", "焼酎", "ハイボール", "ソフトドリンク"],
    description: "手羽先グランプリ16年連続最高金賞受賞の九州料理専門店。全席掘りごたつ・馬刺し・もつ鍋も充実。28名宴会対応可。",
    reasonTags: ["手羽先グランプリ金賞", "九州料理", "掘りごたつ"],
    walkingMinutes: 3,
    healthScore: 3,
    healthTags: ["高たんぱく"],
  ...
  },
  {
    ...
    budget: "¥3,000〜3,999",
    estimatedCalories: 700,
    drinkPairings: ["ビール", "ハイボール", "日本酒", "焼酎", "ソフトドリンク"],
    description: "駅東口徒歩30秒の大衆居酒屋。創作肉料理（鶏レバー・豚の角煮・ラム）が看板で、2時間飲み放題1,980円が人気。",
    reasonTags: ["駅徒歩30秒", "飲み放題1,980円", "創作肉料理"],
    walkingMinutes: 1,
    healthScore: 2,
    healthTags: ["肉料理充実"],
  ...
  },
  {
    ...
    estimatedCalories: 750,
    drinkPairings: ["ビール", "日本酒", "焼酎", "ハイボール", "ソフトドリンク"],
    description: "掘りごたつの完全個室居酒屋。和モダンなひと手間料理と生ビール込み飲み放題コースが充実。2〜55名まで個室対応。",
    reasonTags: ["完全個室", "掘りごたつ", "駅徒歩1分"],
    walkingMinutes: 1,
    healthScore: 3,
    healthTags: ["野菜多め"],
